...
- Before any LibTV operation, read `libtv:libtv-plugin-basics` for current login, project, spend, monitoring, verification, and browser-handoff rules. This is an operational contract, not the creative workflow.
